...
h5. What does future look like?

p. Seam 3 Mail will continue to provide releases in its current format until the time comes for it to transition to "Apache DeltaSpike":http://incubator.apache.org/deltaspike/. In the meantime if you have features for fixs to contribue just open a "JIRA":http://jira.jboss.org/browse/SEAMMAIL and I'll be happy to work them in.
